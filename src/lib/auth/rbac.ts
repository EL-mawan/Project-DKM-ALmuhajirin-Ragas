...
export const ROLE_CONFIGS = {
  ...
  TOKOH_MASYARAKAT: {
    ...
    description: 'Akses peninjauan dan manajemen sistem',
    permissions: [
  ...
  KETUA_DKM: {
    name: 'Ketua DKM',
    description: 'Menyetujui kegiatan dan memiliki akses penuh manajemen',
    permissions: [
      PERMISSIONS.STRUCTURE_READ,
      PERMISSIONS.STRUCTURE_CREATE,
      PERMISSIONS.STRUCTURE_UPDATE,
